...
- ClassifyNode 实施期起配 **4 组** few-shot（覆盖含图函数 / 多小问拆分等边界场景；2026-06-07 修正——原"不配 few-shot"与 §4.3.2 含图函数 fixture 要求矛盾，经裁决按"接线 few-shot"口径统一）；VisionNode 实施期起配 3 组 few-shot（见 §4.3.1 / DR-014，2026-06-04 修正本条与 §4.3.1 的文档内矛盾）
