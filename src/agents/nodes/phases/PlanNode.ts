...
import { systemPrompt, userPromptTemplate, fewShots } from "@/agents/prompts/phases/planNode.prompt";
...
export const planNode = async (state: ElicitGraphState) => {
    ...
    // 调用 DeepSeek（temperature / max_tokens 见 planNode.prompt.ts 中的 modelParams 文档，
