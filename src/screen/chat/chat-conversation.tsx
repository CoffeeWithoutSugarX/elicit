...
export default function ChatConversation(props: ChatConversationProps) {
    ...
    return (
        <div className={"flex flex-row items-center justify-between pr-4 pl-4"}>
            <Button
                className={"w-full pl-4 pt-2 pb-2 rounded-4xl hover:bg-muted-foreground/50 cursor-pointer" + (props.id === currentConversationId ? " bg-foreground text-background" : " bg-background text-foreground")}
